...
collection_name = "first_run_eduscience_data"
...
db_directory = os.path.join(os.path.expanduser('~'), 'Documents/rag-framework/data/', 'first_run_eduscience_data.db')  #default. Change it to where you want to store the vector DB
